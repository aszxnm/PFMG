...
def parse_args():
    ...
    parser.add("--wandb_mode", default="disabled", choices=["disabled", "offline", "online"], type=str)
    ...
    parser.add("--train_data_path", default="/data/trinity/train/", type=str)
    parser.add("--val_data_path", default="/data/trinity/val/", type=str)
    parser.add("--test_data_path", default="/data/trinity/test/", type=str)
    parser.add("--mean_pose_path", default="/data/trinity/train/", type=str)
    parser.add("--std_pose_path", default="/data/trinity/train/", type=str)
    
    # for pretrian weights
    parser.add("--torch_hub_path", default="../../data/checkpoints/", type=str)

    parser.add("--model_name_last", default="last.pth", type=str)
    parser.add("--model_name_best", default="best.pth", type=str)
    parser.add("--test_ckpt", default="/data/beat_cache/beat_4english_15_141/last.bin")
    ...
    parser.add("--pose_pae", default=None, type=str)
    parser.add("--pose_world", default=None, type=str)
    parser.add("--audio_mfcc", default=None, type=str)
    parser.add("--pose_vel", default=None, type=str)
    parser.add("--world_axis", default=None, type=str)
    ...
    parser.add("--no_adv_epochs", "--no_adv_epoch", default=0, type=int)
    ...
    parser.add("--window", default=2.0, type=float)
    parser.add("--embedding_channels", default=10.0, type=float)
#    parser.add("--gan_noise_size", default=0, type=int)

    # --------------- device -------------------------- #
    parser.add("--random_seed", default=3407, type=int)
    ...
    parser.add("--max_train_batches", default=0, type=int, help="Limit train batches for smoke tests; 0 means full epoch.")
    parser.add("--max_val_batches", default=0, type=int, help="Limit val batches for smoke tests; 0 means full validation.")
    parser.add("--max_test_batches", default=0, type=int, help="Limit test batches for smoke tests; 0 means full test set.")
