...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Build a BEAT vocabulary pickle from prepared TextGrid cache.")
    parser.add_argument("--data_path", required=True, help="Prepared BEAT cache root containing train/val/test text folders.")
    parser.add_argument("--cache_path", required=True, help="Output vocab.pkl path.")
    parser.add_argument("--word_vec_path", default=None, help="Optional fastText .bin path.")
    parser.add_argument("--feat_dim", default=300, type=int)
    args = parser.parse_args()
    build_vocab("beat_english_15_141", args.data_path, args.cache_path, args.word_vec_path, args.feat_dim)
